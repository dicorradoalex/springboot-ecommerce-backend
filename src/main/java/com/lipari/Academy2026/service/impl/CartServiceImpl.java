...
public class CartServiceImpl implements CartService {
    ...
    /**
     * Aggiunge o aggiorna la quantità di un prodotto nel carrello dell'utente.
     */
    @Override
    @Transactional
    ...
    /**
     * Recupera il carrello associato all'utente corrente.
     */
    @Override
    ...
    /**
     * Rimuove un elemento dal carrello tramite l'ID del prodotto.
     */
    @Override
    @Transactional
    ...
    /**
     * Svuota tutti gli elementi dal carrello dell'utente.
     */
    @Override
    @Transactional
    ...
    /**
     * Metodo helper per recuperare l'utente attualmente autenticato nel sistema.
     */
